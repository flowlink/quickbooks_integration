module QBIntegration
  class CreditMemo < Base
    ...
    def create
      if credit_memo = credit_memo_service.find_by_number
      ...
      credit_memo = credit_memo.create
    ...
    def update
      credit_memo = credit_memo_service.find_by_number
      ...
      if !credit_memo.present? && config[:quickbooks_create_or_update].to_s == "1"
        ...
        credit_memo = credit_memo.update
